...
def main():
    ...
    parser.add_argument('arg1', help='Server Type, i.e t3a.micro, t3a.small, etc. (see https://aws.amazon.com/ec2/instance-types/ for more options)')
    parser.add_argument('arg2', help='Owner Name, i.e who is the owner of the server')
    parser.add_argument('arg3', help='Server Name, i.e what do you want to name the server')
    args = parser.parse_args()

    # The first argument (index 0) is the name of the script itself
    # create argument parser
    #if len(args) == 4:
    server_type = args.arg1
    owner = args.arg2
    server_name = args.arg3
    ...
    topic_arn, topic_arn_disk, topic_arn_memory = create_cloudwatch_alarm(instance_id, instance_name)
    subscribe_to_alarm(topic_arn, topic_arn_disk, topic_arn_memory)
